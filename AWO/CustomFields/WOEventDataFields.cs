...
internal static class WOEventDataFields
{
    ...
    {
        FieldInjector<WardenObjectiveEventData>.DefineManagedField<WEE_EventData>("m_WEEData");
    }

    public static void SetWEEData(this WardenObjectiveEventData target, WEE_EventData data)
    {
        FieldInjector<WardenObjectiveEventData>.TrySetManagedField(target, "m_WEEData", data);
    }

    public static WEE_EventData GetWEEData(this WardenObjectiveEventData target)
    {
        FieldInjector<WardenObjectiveEventData>.TryGetManagedField<WEE_EventData>(target, "m_WEEData", out var data);
        return data;
    }
}
